                        ...
                        <div class="x_content">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($presentWorks as $key => $presentWork)
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="/presentWorkThumbnail/{{ $presentWork->id }}">
                                                        <i class="material-icons">image</i>
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="/presentWorkImages/{{ $presentWork->id }}">
                                                        <i class="material-icons">image</i>
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="/editPresentWork/{{ $presentWork->id }}">
